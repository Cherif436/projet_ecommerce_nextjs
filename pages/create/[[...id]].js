...
const ProductsManager = () => {
    ...
    const handleUploadInput = e => {
        ...
        if(files.length === 0) 
        return dispatch({type: 'NOTIFY', payload: {error: 'Les fichiers n\'existent pas.'}})

        files.forEach(file => {
            if(file.size > 1024 * 1024)
            return err = 'La plus grande taille d\'image est de 1 Mo'

            if(file.type !== 'image/jpeg' && file.type !== 'image/png')
            return err = 'Image format incorrecte.'
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Sélectionnez jusqu\'à 5 images.'}})
    ...
    const handleSubmit = async(e) => {
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Authentication invalide.'}})

        if(!title || !price || !inStock || !description || !content || category === 'all' || images.length === 0)
        return dispatch({type: 'NOTIFY', payload: {error: 'Veuillez ajouter tous les champs.'}})
        ...
        <div className="products_manager">
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    placeholder="Titre" className="d-block my-4 w-100 p-2"
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            ...
                            placeholder="Prix" className="d-block w-100 p-2"
                            onChange={handleChangeInput} />
                        </div>
                    ...
                    placeholder="Contenu" onChange={handleChangeInput}
                ...
                <div className="col-md-6 my-4">
                    <div className="input-group mb-3">
                        <div className="input-group-prepend">
                            <span className="input-group-text">Joindre une image</span>
                        </div>
