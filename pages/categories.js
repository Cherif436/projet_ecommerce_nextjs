...
const Categories = () => {
    ...
    const createCategory = async () => {
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Authentication invailde.'}})

        if(!name) return dispatch({type: 'NOTIFY', payload: {error: 'Ce champs ne doit pas étre vide.'}})
    ...
    return(
        <div className="col-md-6 mx-auto my-3">
            ...
            <div className="input-group mb-3">
                ...
                placeholder="Ajouter une categorie" value={name}
