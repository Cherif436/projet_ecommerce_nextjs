        ...
        <div className="edit_user my-3">
            ...
            <div>
                <button className="btn btn-dark" onClick={() => router.back()}>
                    <i className="fas fa-long-arrow-alt-left" aria-hidden></i> Retour
                </button>
            </div>

            <div className="col-md-4 mx-auto my-4">
                <h2 className="text-uppercase text-secondary">Editer information utilisateur</h2>
                ...
                <button className="btn btn-dark" onClick={handleSubmit}>Editer</button>
